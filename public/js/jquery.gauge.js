        ...
        (function() {
          function update() {
            ...
            if (position > 0) {
              ...
              ctx.stroke();
                new_arrow_position =  position - 90;
                
                 $('#'+ctx.canvas.id).parent('div').children('.gauge-arrow').css('transform', 'rotate('+new_arrow_position+'deg)');
             ;
            ...
            // Center the text, deducting half of text width from position x
            text_width = ctx.measureText(text).width;
            ctx.fillText( '', centerW - text_width / 2, H - 10);
          }
