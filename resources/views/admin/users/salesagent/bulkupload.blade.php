                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 tpv_heading">
                        <div class="client-bg-white">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('admin.sales.agents.download-sales-agents-sample') }}" class="btn btn-green pull-right">Download Sample File</a>
                                </div>
                            </div>
                            ...
                            <div class="sales_tablebx mb30 mt30">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr class="list-users">
                                                <td class="dark_c">Client</td>
                                                <td class="grey_c">You can enter the client name in this field. </a></td>
                        ...
                        <div class="client-bg-white mt30">
                            ...
                            <form id="import-form" action="{{ route('admin.sales.agents.save-bulk-upload') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="bulk-bottom-area">
                                    ...
                                    <div class="row mt30">
                                        <div class="col-xs-12 col-md-12">
                                            ...
                                            <a href="{{ route('admin.sales.agents') }}"><button class="btn btn-red" type="button">Cancel</button></a>
                                        </div>
                                    </div>
                                </div>
                            </form>
