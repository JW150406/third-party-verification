...
<div class="dashboard-bg daseboard-update dashboard-header">
  <div class="container-fluid">
      <div class="row">
        @include('admin.dashboard.mobile-tabs', ['user' => $user, 'type' => $type])
      </div>
    </div>
...
<div class="dashboard-bg daseboard-update">
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-12" id="dashboard-warp">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    @include('admin.dashboard.client-tab.top_performer',['height' => 248])
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
...
@elseif($type == "salescenter")
  @if ($sId != "")
    @include('admin.dashboard.sales-centers-subtab', ['user' => $user, 'salesCenters' => $salesCenters, 'type' => $type, 'cId' => $cId, 'sId' => $sId, 'identifier' => $identifier])
  @else
    @include('admin.dashboard.sales-centers-tab', ['user' => $user, 'salesCenters' => $salesCenters, 'type' => $type, 'cId' => $cId, 'sId' => $sId, 'identifier' => $identifier])
  @endif
@endif
...
<script>
     function calcWidth() {
        ...
        if (navwidth >0 && navwidth > availablespace) {
