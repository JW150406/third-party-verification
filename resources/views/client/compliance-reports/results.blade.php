...
<div class="add-newlink">
   <a class="btn btn-success btn-icon icon-left" href="{{ route('client.compliance-reports-export',['client_id' => $client_id]).$quert_string  }}"> <i class="fa fa-download"></i> Export</a>
