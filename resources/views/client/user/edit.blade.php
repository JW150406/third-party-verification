                     ...
                     <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="agent-detailform">
                                ...
                                @endif
                                 ...
                                 <form  role="form" method="POST" action="{{ route('client.user.edit',['id' => $user->client_id, 'userid' => $user->id]) }}">
                                   {{ csrf_field() }}
                                 ...
                                 <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <input id="Title" type="text" class="form-control" placeholder="Title"  name="title"  value="{{$user->title}}"   >
                                 ...
                                 <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    <input id="password" type="text" class="form-control" placeholder="Password"  name="password"  value=""   >
                                 ...
                                 <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                    ...
                                    <input id="password_confirmation" type="text" class="form-control" placeholder="Confirm Password"  name="password_confirmation"  value=""   >
                                    <?php echo getFormIconImage('images/form-pass.png') ?>
                                ...
                                <button type="submit" class="btn btn-green">
                                     ...
                                     <a class="btn btn-red" href="{{ route('client.users',$user->client_id) }}">Cancel<span class="del"><?php echo getimage('images/cancel_w.png') ?></span></a>
                                </div>
                                </div>
