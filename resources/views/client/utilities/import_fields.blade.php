...
$breadcrum[] =  array('link' => '' , 'text' =>  "Add Utility"); 
breadcrum ($breadcrum);
 ?>
 ...
 <div class="tpv-contbx">
			<div class="container">
                ...
                <form  method="POST" action="{{ route('utility.import_process',['client_id' => $client_id]) }}">
                {{ csrf_field() }}
                                ...
                                <thead>
                                    ...
                                    @if($i==$icount)
                                        ...
                                        <?php 
                                            ...
                                            ?>
                                        <!-- <tr>
                                        <td class="{{$first_last_td_class}}">Commodity </td>
                                        <td class="{{$second_and_middle_td_class}}"></td>
                                        <td class="{{$first_last_td_class}}">
                                            <select name="fields[commodity]" class="selectsearch" required>
