...
<div class="team-addnewmodal v-star">
    <div class="modal fade" id="add_utility_validation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">

                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel"><span><?php echo getimage("images/info-modal.png"); ?></span>Utilities Level Validations</h4>
                </div>
                ...
                <div class="modal-body">
                    <div class="modal-form row">
                        <div class="">
                            ...
                            <form enctype="multipart/form-data" id="utility-validatation-form" role="form" method="POST" action="{{ route('client.utility.store.validation',['client' => $client_id]) }}" data-parsley-validate>
                                {{ csrf_field() }}
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.add-utility-validation', function(e) {
