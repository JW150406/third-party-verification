...
@section('content')
	...
	if (Auth::user()->isAccessLevelToClient()) {
		$breadcrum = array(
			...
			array('link' => "", 'text' => 'Validations Bulk Upload'),
		);
	} else {
		$breadcrum = array(
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 tpv_heading">
                            <div class="client-bg-white min-height-solve">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('client.utility.validation.downloadsample') }}"
                                           class="btn btn-green pull-right">Download Sample File</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tr class="list-users">
                                                ...
                                                <td class="grey_c">You can enter the commodity name in this
                                                    field. </a></td>
                                                <td class="grey_c">string 255 bytes</td>
                                            </tr>
                                            <tr class="list-users">
                                                <td class="dark_c">Utility Name</td>
                                                <td class="grey_c">You can enter the utility name in this
                                                    field. </a></td>
                                                <td class="grey_c">string 255 bytes</td>
                                            </tr>
                                            <tr class="list-users">
                                                <td class="dark_c">Label</td>
                                                <td class="grey_c">You can enter the label in this field. </a></td>
                                                <td class="grey_c">string 255 bytes</td>
                                            </tr>
                                            <tr class="list-users">
                                                <td class="dark_c">Regex</td>
                                                <td class="grey_c">You can enter the regular expression in this
                                                    field. </a></td>
                                                <td class="grey_c">string 255 bytes</td>
                                            </tr>
                                            <tr class="list-users">
                                                <td class="dark_c">Regex Message</td>
                                                <td class="grey_c">You can enter the regular expression message in this
                                                    field. </a></td>
                                                <td class="grey_c">string 255 bytes</td>
                                            </tr>
                                            </tbody>
                            ...
                            <div class="client-bg-white  min-height-solve mt30">
                                ...
                                <form id="import-form"
                                      action="{{ route('client.utility.validation.import',['client' =>$client->id]) }}"
                                    ...
                                    <div class="bulk-bottom-area">
                                        ...
                                        <div class="row mt30">
                                            <div class="col-xs-12 col-md-12">
                                                <button class="btn btn-green mr15" id="upload-btn" type="button">
                                                    Upload
                                                </button>
                                                <a href="{{ route('client.show', array($client->id))}}#Utilities">
