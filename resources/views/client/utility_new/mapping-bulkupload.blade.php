...
@section('content')
	...
	if (Auth::user()->isAccessLevelToClient()) {
		$breadcrum = array(
			...
			array('link' => "", 'text' => 'Mappings Bulk Upload'),
		);
	} else {
		$breadcrum = array(
                    ...
                    <div class="cont_bx3">
                        <div class="col-xs-12 col-sm-12 col-md-12 tpv_heading">
                            <div class="client-bg-white min-height-solve">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h1>Bulk Upload Mapping</h1>
                                    </div>

                                    <div class="col-md-6">
                                        <a href="{{ route('client.utility.mapping.downloadsample') }}"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="list-users">
                                                    <td class="dark_c">Mapped Commodity</td>
                                                    <td class="grey_c">You can enter the commodity name in this field. </a></td>
                                                    <td class="grey_c">string 255 bytes</td>
                                                </tr>
                                                <tr class="list-users">
                                                    <td class="dark_c">Mapped Brand Name</td>
                                                    <td class="grey_c">You can enter the brand name in this field. </a></td>
                                                    <td class="grey_c">string 255 bytes</td>
                                                </tr>
                                                <tr class="list-users">
                                                    <td class="dark_c">Mapped Utility Provider</td>
                                                    <td class="grey_c">You can enter the utility provider in this field. </a></td>
                                                    <td class="grey_c">string 255 bytes</td>
                                                </tr>
                                                <tr class="list-users">
                                                    <td class="dark_c">Mapped Abbreviation</td>
                                                    <td class="grey_c">You can enter the abbreviation in this field. </a></td>
                                                    <td class="grey_c">string 255 bytes</td>
                                                </tr>
                            ...
                            @endif
                            <div class="message" id="data-errors"></div>
                            <div class="client-bg-white  min-height-solve mt30">

                                <form id="import-form"
                                      action="{{ route('client.utility.mapping.import',['client' =>$client->id]) }}"
