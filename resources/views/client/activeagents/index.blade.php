...
@section('content')
<?php
$breadcrum = array(array('link' => '', 'text' => 'Upload file for sales agents'));
breadcrum($breadcrum)
?>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="{{$first_last_td_class}}">
                                       <div class="btn-group">
                                          <a class="uploaddocument-to-salesagent btn" href="javascript:void(0)" data-toggle="tooltip" data-placement="top" data-container="body" title="" data-original-title="Upload a File" data-uid="{{ $agent_user->id }}" id="delete-salescentersaleuser-{{ $agent_user->id }}" data-salescentersaleuser="{{ $agent_user->first_name }} {{ $agent_user->last_name }}" data-sid="{{ $agent_user->salescenter_id }}">
...
<!-- Modal -->
@include('client.activeagents.uploadfile')
