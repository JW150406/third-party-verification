...
@section('content')
<?php
$breadcrum = array(array('link' => '', 'text' => 'In-active sales agents report'));
breadcrum($breadcrum);
$request = Request::all();
?>
                  ...
                  <div class="col-xs-12 col-sm-3 col-md-3">
                     ...
                     <div class="select-center-wrapper">
                        <select class=" select-box-admin selectcenter" name="salecenter" id="salecenters">
                           <option value="">All Salescenters</option>
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 sales_tablebx client-new-tabs">
                  <div class="client-bg-white">
                     ...
                     <div class=" ">
                        ...
                        <a class="btn btn-green pull-right" href="{{ route('reports.inactiveSalesagentsExports',$exportinactivesalesagents) }}">Export </a>
                     </div>
                     @endif
                           ...
                           <table class="table mt30">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="{{$first_last_td_class}}">{{ $agent_user->hire_options }}</td>
