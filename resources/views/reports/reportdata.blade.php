   ...
   <table class="table">
    ...
    if($i % 2 == 0){
       ...
       <?php
        ...
        $reportdata = ( new App\models\Reports)->DualDataElectricCommodity($report->ExternalSalesId);
       ...
       ?>
        <tr>
            ...
            <?php
                $reportdata = ( new App\models\Reports)->DualDataGasCommodity($report->ExternalSalesId);
                if( count($reportdata) > 0  ){
                    $report = $reportdata[0];
